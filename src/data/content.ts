...
const magnesianewsSource = { label: 'Magnesia News — Αντετοκούνμπο σε γκράφιτι στο γήπεδο του Λαύκου', url: 'https://magnesianews.gr/athlitismos/basket/antetokoynmpo-se-gkrafiti-sto-gipedo-toy-laykoy.html' };
...
export const places: Place[] = [
  ...
  },
  {
    ...
    title: { el: 'Δημοτικό Σχολείο & Γήπεδο Λαύκου — Graffiti Αντετοκούνμπο', en: 'Lafkos School & Sports Court — Antetokounmpo Mural' },
    eyebrow: { el: 'Ανοιχτό γήπεδο & σύγχρονη τοπική τέχνη', en: 'Open sports court & local street art' },
    summary: { el: 'Το ανοιχτό γήπεδο μπάσκετ και ποδοσφαίρου του σχολικού συγκροτήματος, γνωστό για το εντυπωσιακό graffiti του Γιάννη Αντετοκούνμπο που φιλοτέχνησαν κάτοικοι του χωριού το 2021.', en: 'The village primary school sports grounds, celebrated for the large-scale Giannis Antetokounmpo mural painted by local residents in 2021 after the NBA championship.' },
    body: {
      el: [
    ...
    category: 'community',
    geometry: { type: 'Point', coordinates: [23.24680, 39.17315] },
    mapAnchor: [23.24680, 39.17315],
...
export const trails: Trail[] = [
  {
    ...
    waypoints: [
      ...
      { title: { el: 'Κρήνη Χατζή', en: 'Chatzi Spring' }, coordinate: [23.24412, 39.18205], image: chatziSpringImage },
  ...
  },
  {
    ...
    summary: { el: 'Γαλήνια πορεία βορειοανατολικά του χωριού μέσα από αιωνόβιους ελαιώνες και αγροτικά τοπία προς το φρουριακό μοναστήρι του 1795.', en: 'A peaceful northeast-bound walk through century-old olive groves and pastoral scenery to the 1795 fortified monastery.' },
    body: {
      el: [
    ...
    difficulty: 'moderate',
    surface: { el: 'Αγροτικός χωματόδρομος, μονοπάτι και καλντερίμι', en: 'Unpaved rural track, earth footpath, and stone lane' },
    safety: {
      el: ['Εύκολη προς μέτρια διαδρομή μέσα από ελαιώνες και αγροτικά τοπία.', 'Φέρτε καπέλο και νερό καθώς τμήματα της διαδρομής είναι εκτεθειμένα στον ήλιο.'],
      en: ['Easy to moderate route across olive orchards and pastoral landscapes.', 'Bring sun protection and water as portions are open to the sky.'],
    },
    waypoints: [
      { title: { el: 'Πλατεία Λαύκου', en: 'Lafkos Square' }, coordinate: squareCoord, image: squareImage },
      { title: { el: 'Κοιλάδα Κωτίκι', en: 'Kotiki Valley' }, coordinate: [23.26055, 39.19606], image: lafkosAerialWideImage },
      { title: { el: 'Μονή Αγίου Αθανασίου (1795)', en: 'Monastery of Agios Athanasios' }, coordinate: [23.28037, 39.21299], image: promyriChurchImage },
    ],
    sources: [pelionRoutesSource, wikimediaSource, osmSource],
    featured: true,
    isSeed: true,
  ...
  },
  {
    ...
    waypoints: [
      ...
      { title: { el: 'Παλαιοβρύση', en: 'Palaiovrysi Spring' }, coordinate: [23.24510, 39.17520], image: pelionFountainImage },
      { title: { el: 'Κρήνη Τουλούμπα (1910)', en: 'Touloumba Spring' }, coordinate: [23.24835, 39.17580], image: touloumbaSpringImage },
      { title: { el: 'Κρήνη Χατζή (1800)', en: 'Chatzi Spring' }, coordinate: [23.24412, 39.18205], image: chatziSpringImage },
    ],
    sources: [localHeritageSource, wikimediaSource, osmSource],
    featured: true,
    isSeed: true,
